...
public class Column
{
     ...
     * @return 是否需要括号
     */
    public static boolean hasBracket(final Type type) {
        final String name = type.getName();
        return name.equals(Char.CHAR.getName()) || 
               name.equals(Char.VARCHAR.getName()) || 
               name.equals(Integer.INT.getName()) || 
               name.equals(Integer.TINYINT.getName()) || 
               name.equals(Integer.SMALLINT.getName()) || 
               name.equals(Integer.MEDIUMINT.getName()) || 
               name.equals(Integer.BIGINT.getName()) || 
               name.equals(Float.FLOAT.getName()) || 
               name.equals(Float.DOUBLE.getName()) || 
               name.equals(Float.DECIMAL.getName());
    }
